    ...
    return (
        <section className="py-24 bg-slate-50/50">
            <div className="mx-auto max-w-6xl px-6">
                ...
                <div className="flex overflow-x-auto snap-x snap-mandatory pb-6 pt-2 gap-6 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-8 md:overflow-visible no-scrollbar">
                    {projects.map((project) => (
                        <Card key={project.id} className="group flex flex-col overflow-hidden rounded-3xl border-slate-200 bg-white shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl min-w-[280px] sm:min-w-[320px] md:min-w-0 snap-center shrink-0 md:shrink border">
                            {/* Image Container */}
